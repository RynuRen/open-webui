...
class ERROR_MESSAGES(str, Enum):
    ...
    INVALID_EMAIL_FORMAT = "The email format you entered is invalid. Please double-check and make sure you're using a valid email address (e.g., example@hkcloud.co.kr)."
    INVALID_PASSWORD = (
